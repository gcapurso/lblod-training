...
(define-resource book ()
  :class (s-prefix "gi:Book")
  :properties `((:title :string ,(s-prefix "gi:title"))
                (:isbn :string ,(s-prefix "gi:isbn"))
                (:price :string ,(s-prefix "gi:price"))
                )
;;   :has-many `((theme :via ,(s-prefix "dcat:theme")
;;                      :as "themes"))
    :has-one `((author :via ,(s-prefix "gi:hasAuthor")
                    :inverse t
                    :as "author"))                
  :resource-base (s-url "http://webcat.tmp.tenforce.com/books/")
  :on-path "books")

(define-resource author ()
  :class (s-prefix "gi:Author")
  :properties `((:first-name :string ,(s-prefix "gi:firstName"))
                (:second-name :string ,(s-prefix "gi:secondName")))
  :has-many `((book :via ,(s-prefix "gi:hasAuthor")
                     :as "books"))
  :resource-base (s-url "http://webcat.tmp.tenforce.com/authors/")
  :on-path "authors")